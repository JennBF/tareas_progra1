...
{
    this->filasTablero = filasTablero; //THIS ES PARA APUNTAR AL OBJETO QUE ESTOY USANDO.
...
void Config::menuConfiguracion() //Clase heredada, de config. Heredara parametros de la clase
{
    int opciones;
    int valorIngresado;
    bool repetir = true;
...
{
    this->columnasTablero=columnasTablero; //Este es el atributo del objeto, This significa puntero a memoria. APUNTA AL ATRIBUTO DEL OBJETO
}
